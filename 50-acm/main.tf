...
# Below resource is for records creation and we will do for validation purpose, this is for to verify that the domain name is relly ours or not, please check manually in AWS GUI for better understanding #
...
# Below resource creation is to submit the validation button #
